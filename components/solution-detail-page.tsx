...
export function SolutionDetailPage({ locale, pageKey, tc }: SolutionDetailPageProps) {
  ...
  const localTrans: Record<string, Record<string, {
    ...
    en: {
      ...
      'it-staffing-solutions': {
        ...
        title: "IT Staffing",
        titleHighlight: "Solutions",
        description: "Source and place pre-screened, certified data, software, and management experts to hit project timelines.",
        overviewTitle: "Deploy Highly-Certified Technology Talent in Days, Not Months",
        overviewP1: "In a competitive technology landscape, finding qualified software developers, data modelers, and systems architects is slow and expensive. Hiring errors drag down project timelines and waste internal engineering management bandwidth.",
        ...
        techTitle: "Technologies & Tools",
        ctaTitle: "Ready to Optimize Your IT Staffing?",
        ctaDesc: "Schedule a consultation with our recruitment practice directors to align your contract or permanent technical staffing needs.",
        ctaBtn: "Schedule Consultation",
        benefits: [
          { title: 'Vetted Technology Talent', desc: 'Access pre-screened developers, cloud engineers, database administrators, and BI experts with validated credentials.' },
          { title: 'Flexible Contract Placements', desc: 'Quickly resource temporary engineering tasks or fill core skills gaps with developers contracted for 3 to 12 months.' },
          { title: 'Direct Placement Vetting', desc: 'Source key permanent technology managers, directors, and developers, leveraging our database of over 12,000 specialists.' },
  ...
  localTrans.es = {
    ...
    'it-staffing-solutions': {
      ...
      title: "Personal de",
      titleHighlight: "TI",
      description: "Busque y coloque expertos técnicos preseleccionados y certificados en datos, software y gestión para cumplir con los plazos.",
      overviewTitle: "Despliegue Talento Tecnológico Altamente Certificado en Días, No Meses",
      overviewP1: "En un panorama tecnológico competitivo, encontrar desarrolladores de software calificados y arquitectos de sistemas es lento y costoso. Los errores de contratación retrasan los plazos del proyecto y desperdician ancho de banda.",
      overviewP2: "HyperCode simplifica el personal tecnológico. Realizamos filtros de detección rigurosos, verificando los estándares de codificación y la competencia en arquitectura. Entregamos especialistas preseleccionados rápidamente.",
      keySolutionsLabel: "Soluciones Clave",
      benefitsTitle: "Beneficios de Personal Medibles",
      techTitle: "Tecnologías y Herramientas",
      ctaTitle: "¿Listo para Optimizar su Personal de TI?",
      ctaDesc: "Programe una consulta con nuestros directores de reclutamiento para alinear sus necesidades de personal técnico temporal o permanente.",
      ctaBtn: "Programar Consulta",
      benefits: [
        { title: 'Talento Tecnológico Evaluado', desc: 'Acceda a desarrolladores, ingenieros de nube, administradores de bases de datos y expertos en BI preseleccionados con credenciales validadas.' },
        { title: 'Colocaciones de Contrato Flexibles', desc: 'Resuelva rápidamente tareas de ingeniería temporales o cubra brechas de habilidades con desarrolladores contratados de 3 a 12 meses.' },
        { title: 'Evaluación de Colocación Directa', desc: 'Busque gerentes, directores y desarrolladores de tecnología permanentes clave, aprovechando nuestra base de datos de más de 12,000 especialistas.' },
