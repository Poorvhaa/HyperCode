        ...
        <div className="hidden lg:grid grid-cols-12 gap-8 items-center min-h-[620px] relative">
          ...
          <div className="col-span-4 flex flex-col justify-center space-y-6 z-20">
            ...
            <div className="relative group w-full max-w-[340px]">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-royal-blue/6 to-green/4 rounded-lg blur opacity-60 transition duration-1000" />
              
              <div className="relative w-full min-h-[290px] rounded-lg border border-slate-200/80 bg-white/95 backdrop-blur-xl p-7 shadow-[0_8px_20px_rgba(0,0,0,0.015)] flex flex-col justify-between select-none">
                  ...
                  >
                    <div>
                       <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-tr from-royal-blue/8 to-green/4 border border-royal-blue/10 text-royal-blue flex items-center justify-center">
                          {activeItem ? (
                            (() => {
                        ...
                        {clickedIdx !== null && (
                          <button
                            ...
                            className="p-1.5 rounded-lg border border-slate-200 bg-white hover:border-slate-355 text-slate-500 hover:text-slate-700 transition shadow-2xs flex items-center gap-1 text-xs font-black uppercase tracking-wider cursor-pointer"
                          >
                            <X size={8} />
                      ...
                      <p className="text-body-lg text-slate-500 mt-2 max-w-[280px]">
                    ...
                    <div className="space-y-3 pt-3 border-t border-slate-100 mt-auto">
                      <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-green/8 text-xs font-black tracking-wider text-green">
                      ...
                      {focusedIdx !== null && activeItem && (
                        <div className="flex items-center">
                          <Link
                            ...
                            className="inline-flex items-center gap-1 text-xs font-black uppercase tracking-wider text-royal-blue hover:gap-1.5 transition-all"
                          >
          ...
          <div
            ref={parentRef}
            className="col-span-8 relative w-full h-[550px] xl:h-[650px] flex items-center justify-center pointer-events-auto overflow-visible bg-white/70 border border-[#94a3b8]/18 shadow-soft backdrop-blur-md rounded-lg p-6 lg:translate-x-[20px]"
          >
            ...
            <div className="w-full grid grid-cols-12 gap-4 items-center relative z-20">
                ...
                {leftNodes.map((node) => {
                  ...
                  return (
                    <div
                      ...
                      className={`px-4 py-3.5 rounded-lg border bg-white/95 backdrop-blur-md shadow-3xs cursor-pointer transition-all duration-300 flex items-center gap-3.5 select-none ${
                        isHighlighted 
                    ...
                    >
                      ...
                      <div className="text-left leading-tight space-y-0.5">
                        ...
                        {microLabel && (
                          <span className="text-xs font-bold text-slate-600 block tracking-wider uppercase">
                            {microLabel}
                          </span>
                        )}
                      </div>
              ...
              <div className="col-span-4 flex justify-center items-center">
                <div
                  ref={coreRef}
                  className="relative w-full max-w-[200px] aspect-square rounded-lg border border-slate-250 bg-white/90 backdrop-blur-xl shadow-md p-6 flex flex-col items-center justify-center text-center select-none bg-[radial-gradient(circle_at_center,rgba(20,91,255,0.03)_0%,transparent_75%)]"
                >
                  {/* Glowing core indicator */}
                  <div className="absolute inset-0 bg-royal-blue/10 rounded-lg blur-xl animate-pulse pointer-events-none -z-10" />
                  
                  <div className="space-y-3.5 flex flex-col items-center justify-center">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-tr from-royal-blue/10 to-green/5 border border-royal-blue/15 text-royal-blue flex items-center justify-center shadow-2xs">
                      <Cpu size={22} className="animate-spin" style={{ animationDuration: '14s' }} />
                    </div>
                    <div className="leading-none space-y-1">
                      <span className="text-xs font-black tracking-widest text-slate-800 uppercase block">
                        HYPERCODE
                      </span>
                      <span className="text-xs font-bold text-slate-655 font-mono tracking-widest block leading-tight">
                ...
                {rightNodes.map((node) => {
                  ...
                  return (
                    <div
                      ...
                      className={`px-4 py-2.5 rounded-lg border bg-white/95 backdrop-blur-md shadow-3xs cursor-pointer transition-all duration-300 flex items-center gap-3 select-none ${
                        isHighlighted 
                          ? 'border-royal-blue shadow-md translate-x-1 ring-1 ring-royal-blue/15 text-royal-blue' 
                          : 'border-slate-200/80 hover:border-slate-350 text-slate-700'
                      }`}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-body-lg text-slate-500 mt-1">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pt-3 border-t border-slate-100">
                  <span className="text-xs font-black text-green bg-green/8 px-2 py-1 rounded-lg tracking-wider">
                    {focusedIdx !== null ? displayOutcome : (locale === 'es' ? 'ACELERAR VALOR' : 'ACCELERATE VALUE')}
                  </span>
                  {activeItem && (
                    <Link
                      href={activeItem.href}
                      className="inline-flex items-center gap-1 text-xs font-black text-royal-blue uppercase tracking-wider hover:underline"
                    >
                      <span>{locale === 'es' ? 'Ver Detalles' : 'View Service'}</span>
                      <ArrowRight size={11} />
                    </Link>
          ...
          <div className="w-full max-w-md mx-auto space-y-3.5">
            ...
            <div className="p-5 rounded-2xl border border-slate-200 bg-slate-50/50 flex items-center justify-between shadow-2xs select-none">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-royal-blue text-white shadow-3xs">
              ...
              <span className="text-xs font-bold text-slate-655 uppercase tracking-widest border border-slate-200 bg-white px-2 py-0.5 rounded-lg">
                CORE
              </span>
            </div>
              ...
              {serviceNodes.map((node, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`p-3.5 rounded-lg border bg-white flex items-center gap-3 shadow-3xs text-left cursor-pointer transition-all duration-300 w-full focus:outline-none focus:ring-1 focus:ring-royal-blue/20 ${
