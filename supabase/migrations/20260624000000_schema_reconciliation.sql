...
ALTER TABLE chat_leads ADD COLUMN IF NOT EXISTS language TEXT DEFAULT 'en';
...
-- Indexes for staffing_requests
CREATE INDEX IF NOT EXISTS idx_staffing_email ON staffing_requests(email);
CREATE INDEX IF NOT EXISTS idx_staffing_created ON staffing_requests(created_at);
