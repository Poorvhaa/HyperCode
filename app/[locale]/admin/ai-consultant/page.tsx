...
export default function AIConsultantDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const mockLeads = [
        { id: 'l1', conversation_id: 'c1', name: 'John Doe', email: 'john.doe@techcorp.com', phone: '+1 (555) 019-2834', company: 'TechCorp Solutions', industry: 'technology', service_interest: 'AI Solutions', budget_range: '$50,000+ (Enterprise)', timeline: 'Immediate (Under 1 month)', message: 'Need custom LLM agent integrated with our Salesforce workflow.', lead_score: 95, status: 'New', language: 'en', created_at: new Date(Date.now() - 5000000).toISOString() },
