          ...
          services: [
            {
              ...
              shortDesc: 'Placing specialized IT and Non-IT professionals',
              path: '/solutions/it-staffing-solutions',
              benefits: [
                'IT & Non-IT Staffing',
                'Permanent Hiring & Direct Placements',
                'Contract Staffing & Augmentation',
      ...
      categories: [
        ...
        },
        {
          ...
          services: [
            {
              id: 'it-staffing',
              title: 'Contratación de Personal de TI y No TI',
              shortDesc: 'Colocación de profesionales de TI y No TI',
              path: '/solutions/it-staffing-solutions',
              benefits: [
                'Contratación de Personal de TI y No TI',
                'Contratación Permanente y Colocaciones Directas',
                'Contratación por Contrato y Aumento de Personal',
                'Búsqueda Ejecutiva y Selección de Personal',
                'Contratación Masiva y por Volumen',
                'Programas de Reclutamiento Universitario',
                'Outsourcing de Procesos de Reclutamiento (RPO)',
              ],
