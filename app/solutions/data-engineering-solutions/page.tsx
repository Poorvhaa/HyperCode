...
export default function DataEngineeringSolutionsPage() {
  ...
  const industries = [
    { name: 'Financial Services', useCase: 'Secure transaction pipelines, compliance logs, and risk models.' },
    { name: 'Healthcare', useCase: 'Secure HL7/FHIR record integration and HIPAA data audit logs.' },
    { name: 'Government', useCase: 'Audit trails, multi-agency data pipelines, and air-gapped system ingestion.' },
    { name: 'Technology', useCase: 'Application telemetry, customer product event ingestion, and API databases.' },
  ];
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/contact?service=Data%20Engineering"
